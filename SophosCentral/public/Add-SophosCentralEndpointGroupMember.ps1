function Add-SophosCentralEndpointGroupMember {
    <#
    .SYNOPSIS
    ...
    .PARAMETER EndpointID
        The ID of the endpoint(s) to add
    .EXAMPLE
        Add-SophosCentralEndpointGroupMember -ID "14912b3f-d052-49c4-8367-495a72d8013f" -EndpointID "12345678-1234-1234-1234-123456789012"
    .LINK
        https://developer.sophos.com/docs/endpoint-v1/1/routes/endpoint-groups/%7BgroupId%7D/endpoints/post
    #>
    ...
    if ($Force -or $PSCmdlet.ShouldProcess('Add group members', ($ID))) {
